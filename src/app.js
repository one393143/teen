...
const DEFAULT_ARTICLES = [
  {
    ...
    category: '心靈成長',
    badge: '🔥 本週熱門焦點',
    bigDataLabel: '💡 溫馨導讀：近期生活與學業步調較快時，試著給自己放個小假，接納不完美但最真實的自己吧。',
  ...
  },
  {
    ...
    category: '睡眠健康',
    badge: '🌙 晚安放鬆指南',
    bigDataLabel: '💡 晚安密碼：今晚睡前試著放下手機、遠離藍光螢幕，做個簡單的氣味療癒或溫和拉伸，幫助你快速入夢。',
