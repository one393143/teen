...
const DEFAULT_ARTICLES = [
  {
    ...
    category: '容貌焦慮',
    badge: '🔥 高中板熱門第一',
    bigDataLabel: '📌 討論焦點：此話題源於本週全校匿名日記中，「成績單」、「容貌焦慮」、「不想比了」出現率高達 42.1%。',
  ...
  },
  {
    ...
    category: '課業焦慮',
    badge: '☀️ 暑假板熱議',
    bigDataLabel: '📌 討論焦點：近期日記中「暑輔」、「打工重修」、「想翹課」關鍵字熱度上升了 32.8%。',
  ...
  },
  {
    ...
    category: '感情告白',
    badge: '💖 告白樹洞',
    bigDataLabel: '📌 討論焦點：近期日記中「隔壁班學長」、「社團暗戀」、「Threads 告白」出現率攀升了 24.5%。',
    title: '【感情】暗戀隔壁班熱音社學長...要衝一波告白單身嗎？',
    snippet: '最近放學經過音樂教室，看到隔壁班那個彈電吉他的學長真的好帥...😭 後天就是社團發表會了，我要趁機送小禮物並告白嗎？',
    content: '<p>如題，我是高二生... 最近真的暈船暈到不行了 😭。</p><p>上個學期開始，每次放學經過音樂社團教室，都會看到隔壁班一個高高的、彈電吉他的學長。他笑起來有一對小虎牙，真的超級陽光帥氣！每次看到他，我的心臟都快跳出來了...</p><p>後來發現他也有玩 Threads，我偷偷追蹤了他，每天看他發日常碎碎唸，更覺得他是一個超級溫柔的人 😭。後天就是他們的社團期末發表會了，我打算寫一張精美的手繪卡片送給他，但又很怕被他當眾拒絕會超級尷尬... 到時候在學校低頭不見抬頭見...</p><p>大家覺得我要勇敢衝一波告白嗎？還是默默暗戀到畢業就好？真的好苦惱啊啊啊！</p>',
    author: '暗戀中的小水母',
    readTime: '3 分鐘',
    likes: 145,
